...
jacob_eq_val=sparse(jacob_eqf(x_val));

jacob_f=Function('jacob_eqf',{opti.x},{jacobian(new_g,opti.x)});
jacob_val=sparse(jacob_f(x_val));
...
dual_infeasibilities=gradfval'+jacob_val'*lamg+lamx; 
