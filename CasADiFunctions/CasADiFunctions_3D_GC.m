...
if Options.usedCompiled_lMT_vMT_External
    ...
    if exist('f_lMT_vMT_dM.casadi')
        f_lMT_vMT_dM=Function.load('f_lMT_vMT_dM.casadi');
    else
        ...
        fprintf('Computing lMT and ma paramaterization \n');
        for i=1:NMuscle_pol      
        ...
        f_lMT_vMT_dM.save('f_lMT_vMT_dM.casadi');
        fprintf('Computed lMT and ma paramaterization \n');
    end
end
...
if Options.dampingInKneeSec==1
    Tau_pass_kneeintmom = Tau_pass_kneeintmom - qdotin_pass * Options.dampM;
    F_pass_txtz         = F_pass_txtz         - qdotin_pass * Options.dampF;
