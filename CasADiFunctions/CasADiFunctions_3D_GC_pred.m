...
etemp4 = SX.sym('etemp4',4);
Jtemp4 = 0;
for i=1:length(etemp4)
    Jtemp4 = Jtemp4 + etemp4(i).^2;
end
Jtemp4 = Jtemp4/4;
f_J4 = Function('f_J4',{etemp4},{Jtemp4});
...
% Function for 19 elements 
etemp19 = SX.sym('etemp19',19);
Jtemp19 = 0;
for i=1:length(etemp19)
    Jtemp19 = Jtemp19 + etemp19(i).^2;
end
Jtemp19 = Jtemp19/19;
f_J19 = Function('f_J19',{etemp19},{Jtemp19});
% Function for 17 elements 
etemp17 = SX.sym('etemp17',17);
Jtemp17 = 0;
for i=1:length(etemp17)
    Jtemp17 = Jtemp17 + etemp17(i).^2;
end
Jtemp17 = Jtemp17/17;
f_J17 = Function('f_J17',{etemp17},{Jtemp17});
...
% Function for 26 elements
etemp26 = SX.sym('etemp26',26);
Jtemp26 = 0;
for i=1:length(etemp26)
    Jtemp26 = Jtemp26 + etemp26(i).^2;
end
Jtemp26 = Jtemp26/26;
f_J26 = Function('f_J26',{etemp26},{Jtemp26});
...
Tau_pass_kneeintmom=-30*((qin_pass/(7.5*pi/180)).^3);
F_pass_txtz=-200*((qin_pass/0.02).^3); 
