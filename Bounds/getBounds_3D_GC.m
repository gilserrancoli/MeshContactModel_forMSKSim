...
bounds.Qs.upper ([jointi.knee_flex.l jointi.knee_flex.r])=[0 0]; %no knee hyperextension allowed
...
bounds.Qdotdots.upper(jointi.knee_tx.r) = 2*scf_range_qdotdot;
bounds.Qdotdots.lower(jointi.knee_tx.r) = -2*scf_range_qdotdot;
%Knee ty
bounds.Qdotdots.upper(jointi.knee_ty.r) = 2*scf_range_qdotdot;
bounds.Qdotdots.lower(jointi.knee_ty.r) = -2*scf_range_qdotdot;
%Knee tz
bounds.Qdotdots.upper(jointi.knee_tz.r) = 2*scf_range_qdotdot;
bounds.Qdotdots.lower(jointi.knee_tz.r) = -2*scf_range_qdotdot;
% Ankle
