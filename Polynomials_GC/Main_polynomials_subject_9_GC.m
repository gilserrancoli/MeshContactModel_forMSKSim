...
% pathmain = pwd;
% name_dummymotion = 'random_motion_7s_4.mot';
% path_dummymotion = [pathmain,'\MuscleAnalysis\dummy_motion\create_random_motion_15degrees\'];
% path_resultsMA = [pathmain,'\MuscleAnalysis\resultsMA_subject_random_motion_7s_test_4_3.3\'];


pathmain = pwd;
name_dummymotion = 'random_motion_10s.mot';
path_dummymotion = [pathmain,'\MuscleAnalysis\dummy_motion\create_random_motion_15degrees\'];
path_resultsMA = [pathmain,'\MuscleAnalysis\resultsMA_subject_knee_test_new_model_random\'];
...
%     index_dof_crossing_withouknee= find(muscle_spanning_joint_INFO(i,[1:3 6 10:end])==1);
    order                        = MuscleInfo.muscle(i).order;
    [mat,diff_mat_q]             = n_art_mat_9_GC_cas_SX(qin(1,index_dof_crossing),order);
